...
const WarpPanel = () => {
    ...
    const Update = useCallback(() => {
        ...
        const ScreenPos = GameUI.GetScreenWorldPosition([width / 2, height / 2]);
        if (ScreenPos) {
...
const UnitCountsPanel = () => {
    ...
    const Update = useCallback(() => {
        const entity = Entities.GetAllEntitiesByClassname('npc_dota_creature');
                ...
                <Panel className="content">
                    ...
                    <Panel className="row btn-group">
                        ...
                        <Button
                            ...
                            id="ReplaceAbility"
                            onactivate={() => {
                                TogglePopupsViews('Ability', true);
                            }}
                        >
                            <Label text="变更技能" />
                        </Button>
