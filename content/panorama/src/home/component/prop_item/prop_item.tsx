...
function _SetPropItemId(item_id: PropItemId) {
    const item_data = MysteriousShopConfig[item_id as PropItemId];
    const AbilityTextureName = item_data.AbilityTextureName;
    const src = GetTextureSrc(AbilityTextureName);
    ...
    if (params.show_tips != null) {
        if (params.show_tips == true) {
            MainPanel.SetPanelEvent('onmouseover', () => {
                ...
                const rare = MainPanel.Data<PanelDataObject>().rare as number;
