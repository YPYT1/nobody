...
var g_PlayerPanels: Panel[] = [];

var g_TEAM_SPECATOR = 1;

const LockAndStartButton = $("#LockAndStartButton") as Button;
const CancelAndUnlockButton = $("#CancelAndUnlockButton") as Button;
//--------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------
function FindOrCreatePanelForPlayer(playerId: PlayerID, parent: Panel) {
...
//--------------------------------------------------------------------------------------------------
function FindPlayerSlotInTeamPanel(teamPanel: Panel, playerSlot: number) {
...
//--------------------------------------------------------------------------------------------------
function UpdateTeamPanel(teamPanel: Panel) {
	...
	for (var i = teamPlayers.length; i < nNumPlayerSlots; ++i) {
		...
		if (playerSlot && playerSlot.GetChildCount() == 0) {
...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
function OnPlayerSelectedTeam(nPlayerId: PlayerID, nTeamId: number, bSuccess: boolean) {
...
(function () {
	...
	LockAndStartButton.SetPanelEvent("onactivate", OnLockAndStartPressed)
	CancelAndUnlockButton.SetPanelEvent("onactivate", OnCancelAndUnlockPressed)
})();
...
interface CustomUIConfig {
	team_select: {
		bShowSpectatorTeam: boolean;
		bAutoAssignTeams: boolean;
	};
}
