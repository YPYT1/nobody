...
export class modifier_picture_effect_15 extends BaseModifier {
    ...
    GetModifierAura() { return "modifier_picture_effect_15_aura"; }
...
export class modifier_picture_effect_15_aura extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        let buff = this.GetAuraOwner().FindModifierByName("modifier_picture_effect_15") as modifier_picture_effect_15
        let ms_pct = buff ? buff.ms_pct : 0;
        let hp_regen = buff ? buff.hp_regen : 0;
