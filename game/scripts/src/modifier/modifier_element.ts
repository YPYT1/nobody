...
export class modifier_element_effect_fire extends BaseModifier {
    ...
    OnCreated(params: any): void {
        ...
        const interval_increase: number = params.interval_increase ?? 0;
        const base_interval = params.base_interval ?? 1;
    ...
    OnRefresh(params: any): void {
        ...
        const burn_percent = this.caster.custom_attribute_value['BurningDmg'];
...
export class modifier_element_effect_ice extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        const t16_index = hCaster.hero_talent['16'] ?? 0;
        if (t16_index >= 2) {
    ...
    DeclareFunctions(): modifierfunction[] {
        return [ModifierFunction.MOVESPEED_BONUS_PERCENTAGE, ModifierFunction.MOVESPEED_ABSOLUTE_MIN];
    }
