...
export class modifier_mission_radiant_5_ai extends BaseModifier {
    ...
    MovePig() {
        const move_points = (this.last_vect + RandomVector(RandomInt(300, 600))) as Vector;
    ...
    DeclareFunctions(): modifierfunction[] {
        return [ModifierFunction.MOVESPEED_BASE_OVERRIDE, ModifierFunction.IGNORE_MOVESPEED_LIMIT];
    }
