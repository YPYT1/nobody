...
Object.assign(getfenv(), {
    ...
    OnAttackStart: (params: any) => {
        OnAttackStart(params);
    },
    OnAttackLanded: (params: any) => {
...
export const OnDeath = (params: CGDatadrivenProps) => {
    ...
    const picture_buff = hUnit.FindModifierByName('modifier_picture_abilities') as modifier_picture_abilities;
...
export const OnAttack = (params: CGDatadrivenProps) => {
    // print("OnAttack")
    for (const hAbility of params.caster.OnAttackList) {
