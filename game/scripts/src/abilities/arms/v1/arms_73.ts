 ...
 */
@registerAbility()
export class arms_73 extends BaseArmsAbility {
    ...
    OnArmsStart(): void {
        this.caster.AddNewModifier(this.caster, this, "modifier_arms_73_buff", {
...
@registerModifier()
export class modifier_arms_73 extends BaseArmsModifier { }


@registerModifier()
export class modifier_arms_73_buff extends BaseModifier {
