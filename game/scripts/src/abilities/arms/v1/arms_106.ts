...
/**
 * 北极圈	"生成一个寒冰圈围绕在自身周围，对碰
触到的敌人造成伤害，并减速敌人45%持续3秒。
持续时间：5秒
cd：8秒
伤害系数：攻击力50%·冰元素伤害每0.5秒
作用范围：冰圈生成在自身直径500码的地方"

 */
@registerAbility()
export class arms_106 extends BaseArmsAbility {
    ...
    // OnArmsInterval(): void {
    //     this.caster.AddNewModifier(this.caster, this, "modifier_arms_106_buff", {
...
@registerModifier()
export class modifier_arms_106 extends BaseArmsModifier { }


@registerModifier()
export class modifier_arms_106_buff extends BaseModifier {
