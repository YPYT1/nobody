 ...
 */
@registerAbility()
export class arms_72 extends BaseArmsAbility {
    ...
    OnArmsStart(): void {
        this.caster.AddNewModifier(this.caster, this, "modifier_arms_72_buff", {
...
@registerModifier()
export class modifier_arms_72 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_72_buff extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        let effect_fx = ParticleManager.CreateParticle(
            "particles/custom/arms/arms_72_blot.vpcf",
