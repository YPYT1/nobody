...
/**
 * 火龙天翔	"召唤一只持续%summoned_duration%秒的火龙保护召唤者
攻击间隔：1.0
攻击范围：直径600码
雷龙特性：对目标500范围至多4个敌人造成该次伤害的75%溅射伤害。
冰龙伤害：%DamageFormula%"
 */
@registerAbility()
export class arms_156 extends BaseArmsAbility {
    ...
    OnArmsInterval(): void {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_156_summoned", {})
...
@registerModifier()
export class modifier_arms_156 extends BaseArmsModifier {}

@registerModifier()
export class modifier_arms_156_summoned extends BaseModifier {
