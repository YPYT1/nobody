 ...
 */
@registerAbility()
export class arms_118 extends BaseArmsAbility {
    ...
    OnArmsInterval(): void {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_118_summoned", {})
...
@registerModifier()
export class modifier_arms_118 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_118_summoned extends BaseModifier {
