...
export class modifier_arms_8 extends BaseArmsModifier {
    ...
    OnIntervalThink(): void {
        ...
        if (res.status) {
            let skv_resource_income = this.ability.GetSpecialValueFor("skv_resource_income")
            this.lost_amount += math.floor(this.losing_soul * skv_resource_income * 0.01)
