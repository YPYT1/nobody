 ...
 */
@registerAbility()
export class arms_94 extends BaseArmsAbility {
    ...
    OnAffected(event: ModifierAttackEvent): void {
        ...
        this.caster.AddNewModifier(this.caster, this, "modifier_arms_94_invisible", {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_94_summoned", {
...
@registerModifier()
export class modifier_arms_94 extends BaseArmsModifier {

}

@registerModifier()
export class modifier_arms_94_summoned extends BaseModifier {
...
@registerModifier()
export class modifier_arms_94_invisible extends BaseModifier {
