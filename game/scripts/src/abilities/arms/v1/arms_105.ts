 ...
 */
@registerAbility()
export class arms_105 extends BaseArmsAbility {
    ...
    // OnArmsInterval(): void {
    //     this.caster.AddNewModifier(this.caster, this, "modifier_arms_105_buff", {
...
@registerModifier()
export class modifier_arms_105 extends BaseArmsModifier { }


@registerModifier()
export class modifier_arms_105_buff extends BaseModifier {
