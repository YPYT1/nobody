 ...
 */
@registerAbility()
export class arms_158 extends BaseArmsAbility {
...
@registerModifier()
export class modifier_arms_158 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_158_summoned extends BaseModifier {
