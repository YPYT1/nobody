 ...
 */
@registerAbility()
export class arms_70 extends BaseArmsAbility {
    ...
    OnAttackStart(hTarget: CDOTA_BaseNPC): void {
        ...
        if (RollPercentage(this.base_chance) && this.ArmsActTime <= dotaTime) {
            this.ArmsActTime = dotaTime + this.arms_cd;
            CreateModifierThinker(
                this.caster,
                this,
                "modifier_arms_70_thinker",
                {
...
@registerModifier()
export class modifier_arms_70 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_70_thinker extends BaseModifier {
