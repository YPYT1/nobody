 ...
 */
@registerAbility()
export class arms_26 extends BaseArmsAbility {
    ...
    ArmsEffectStart(): void {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_26_summoned", {})
...
@registerModifier()
export class modifier_arms_26 extends BaseArmsModifier {}

@registerModifier()
export class modifier_arms_26_summoned extends BaseModifier {
