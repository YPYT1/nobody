 ...
 */
@registerAbility()
export class arms_135 extends BaseArmsAbility {
    ...
    OnArmsInterval(): void {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_135_summoned", {})
...
@registerModifier()
export class modifier_arms_135 extends BaseArmsModifier {}

@registerModifier()
export class modifier_arms_135_summoned extends BaseModifier {
