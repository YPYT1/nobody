 ...
 */
@registerAbility()
export class arms_67 extends BaseArmsAbility {

    mdf_tinker: string = "modifier_arms_67_thinker";
...
@registerModifier()
export class modifier_arms_67 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_67_thinker extends BaseModifier {
