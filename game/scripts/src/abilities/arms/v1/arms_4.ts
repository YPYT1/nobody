...
export class arms_4 extends BaseArmsAbility {
    ...
    InitCustomAbilityData(): void {
        this.projectile_distance = this.GetSpecialValueFor("projectile_distance");
    ...
    OnArmsInterval(): void {
        ...
        let extra_count = math.min(12, this.GetSpecialValueFor("skv_missile_count") - 1);
        if (extra_count > 0) {
    ...
    OnProjectileHit_ExtraData(target: CDOTA_BaseNPC, location: Vector, extraData: any): boolean | void {
        ...
        if (!thinker) { return; }
        let thinker_buff = thinker.FindModifierByName("modifier_arms_4_powershot") as modifier_arms_4_powershot;
...
@registerModifier()
export class modifier_arms_4_powershot extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        let missile_distance = hAbility.GetSpecialValueFor("missile_distance");
        let missile_speed = hAbility.GetSpecialValueFor("skv_missile_speed");
        let missile_width = hAbility.GetSpecialValueFor("missile_width");
        ...
        let projectile_id = ProjectileManager.CreateLinearProjectile({
            ...
            fStartRadius: missile_width,
            fEndRadius: missile_width,
            vVelocity: (direction * missile_speed) as Vector,
            fDistance: missile_distance,
