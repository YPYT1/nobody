 ...
 */
@registerAbility()
export class arms_t4_1 extends BaseArmsAbility {
    ...
    AffectedEffectStart(event: ModifierAttackEvent): void {
        ...
        this.caster.AddNewModifier(this.caster, this, "modifier_arms_t4_1_invisible", {
        ...
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_t4_1_summoned", {
...
@registerModifier()
export class modifier_arms_t4_1 extends BaseArmsModifier {

}

@registerModifier()
export class modifier_arms_t4_1_summoned extends BaseModifier {
...
@registerModifier()
export class modifier_arms_t4_1_invisible extends BaseModifier {
