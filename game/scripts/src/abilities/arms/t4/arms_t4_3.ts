 ...
 */
@registerAbility()
export class arms_t4_3 extends BaseArmsAbility {
    ...
    ArmsEffectStart(): void {
        ...
        let summoned_unit = CreateUnitByName("summoned_thunder_dragon", vLoc, false, this.caster, this.caster, this.team);
        summoned_unit.AddNewModifier(this.caster, this, "modifier_arms_t4_3_summoned", {
...
@registerModifier()
export class modifier_arms_t4_3 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_t4_3_summoned extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        // this.parent.SetModel("models/heroes/twin_headed_dragon/twin_headed_dragon.vmdl");
