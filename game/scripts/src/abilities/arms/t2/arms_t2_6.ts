 ...
 */
@registerAbility()
export class arms_t2_6 extends BaseArmsAbility {

    GetIntrinsicModifierName(): string {
        return "modifier_arms_t2_6"
    }
...
@registerModifier()
export class modifier_arms_t2_6 extends BaseArmsModifier {

}

@registerModifier()
export class modifier_arms_t2_6_thinker extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        this.wave_interval = hAbility.GetSpecialValueFor("wave_interval");
        this.wave_count = hAbility.GetSpecialValueFor("wave_count");
        this.aoe_radius = hAbility.GetSpecialValueFor("aoe_radius");
        this.wave_timer = 0;
