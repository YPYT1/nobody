 ...
 */
@registerAbility()
export class arms_t3_1 extends BaseArmsAbility {
    ...
    OnArmsExecuted(): void {
        // print("arms_t3_1 OnAbilityExecuted");
        ...
        if (this.activate_time < gameTime) {
            ...
            if (this.stack_buff == null) {
                this.stack_buff = this.caster.AddNewModifier(this.caster, this, "modifier_arms_t3_1_stack", { duration: buff_duration })
            }
...
@registerModifier()
export class modifier_arms_t3_1 extends BaseArmsModifier { }

@registerModifier()
export class modifier_arms_t3_1_stack extends BaseModifier {
    ...
    OnCreated(params: object): void {
        this.stack_count = 1;
        this.ability = this.GetAbility() as arms_t3_1;
