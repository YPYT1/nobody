 ...
 */
@registerAbility()
export class arms_t1_4 extends BaseArmsAbility {
    ...
    OnProjectileHit(target: CDOTA_BaseNPC, location: Vector): boolean | void {
        if (target) {
            target.AddNewModifier(this.caster, this, "modifier_arms_t1_4_dot", {
...
@registerModifier()
export class modifier_arms_t1_4_dot extends ArmsModifier_DOT {
