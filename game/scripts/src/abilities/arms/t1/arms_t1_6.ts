 ...
 */
@registerAbility()
export class arms_t1_6 extends BaseArmsAbility {
    ...
    OnProjectileHit_ExtraData(target: CDOTA_BaseNPC, location: Vector, extraData: any): boolean | void {
        ...
        if (!thinker) { return; }
        let thinker_buff = thinker.FindModifierByName("modifier_arms_t1_6_multishot") as modifier_arms_t1_6_multishot;
...
@registerModifier()
export class modifier_arms_t1_6 extends BaseArmsModifier {

}

@registerModifier()
export class modifier_arms_t1_6_multishot extends BaseModifier {
