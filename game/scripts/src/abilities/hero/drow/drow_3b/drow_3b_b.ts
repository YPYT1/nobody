        ...
        target.SetContextThink(
            ...
            () => {
                ...
                if (this.talent_37) {
                    ...
                    const stack = target.GetModifierStackCount('modifier_drow_3b_b_stack', hCaster);
                    const buff_increase = this.ability.GetTypesAffixValue(stack, 'Buff', 'skv_buff_increase');
