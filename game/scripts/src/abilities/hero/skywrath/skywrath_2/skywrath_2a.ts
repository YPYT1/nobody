...
export class modifier_skywrath_2a extends BaseHeroModifier {
    ...
    OnIntervalThink() {
        if (this.CastingConditions()) {
            ...
            this.ExtraEffect();
            const total_count = this.surround_count;
            // 1个 面向 2个对角 3
...
export class modifier_skywrath_2a_surround extends modifier_motion_surround {
    ...
    C_OnCreated(params: any): void {
        ...
        const effect_name = element_orb[this.element_type];
        const cast_fx = ParticleManager.CreateParticle(effect_name, ParticleAttachment.ABSORIGIN_FOLLOW, this.GetParent());
...
export class modifier_skywrath_2a_surround_collision extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        const rune_61 = this.caster.GetRuneKv('rune_61', 'interval_increase');
