...
export class modifier_skywrath_3b_a_jihan extends BaseModifier {
    ...
    OnCreated(params: any): void {
        ...
        const caster_fx = ParticleManager.CreateParticle(
        ...
        const snow_fx = ParticleManager.CreateParticle(
    ...
    OnIntervalThink(): void {
        ...
        // 极寒领域冰爆 TODO
        for (let i = 0; i < 6; i++) {
            const a = RandomInt(0, 359);
            const r = RandomInt(0, this.radius);
