...
export class modifier_skywrath_5 extends BaseHeroModifier {
    ...
    OnCreated(params: object): void {
        ...
        this.CloneUnit = CreateUnitByName('npc_summoned_skywrath', this.caster.GetAbsOrigin(), false, this.caster, this.caster, this.team);
...
export class modifier_skywrath_5_clone_show extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        const talent_114 = this.caster.GetTalentKv('114', 'bonus_ice');
        const talent_115 = this.caster.GetTalentKv('115', 'reduce_cd_pct');
        const talent_116 = this.caster.GetTalentKv('116', 'image_dmg_bonus');
        const talent_117 = this.caster.GetTalentKv('117', 'shadow');
        ...
        const effecf_fx = ParticleManager.CreateParticle(effect_name, ParticleAttachment.ABSORIGIN_FOLLOW, this.parent);
    ...
    OnDestroy(): void {
        ...
        const killed_fx = ParticleManager.CreateParticle('particles/generic_gameplay/illusion_killed.vpcf', ParticleAttachment.CUSTOMORIGIN, null);
...
export class modifier_skywrath_5_clone extends BaseModifier {
    ...
    DeclareFunctions(): modifierfunction[] {
        return [ModifierFunction.MOVESPEED_BASE_OVERRIDE];
    }
