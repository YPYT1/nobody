...
export class creature_elite_3 extends BaseCreatureAbility {
    ...
    OnSpellStart(): void {
        ...
        const Missile = CreateUnitByName(
...
export class modifier_creature_elite_3_delay extends BaseModifier {
    ...
    OnDestroy(): void {
        ...
        const speed = this.GetAbility().GetSpecialValueFor('speed');
    ...
    DeclareFunctions(): modifierfunction[] {
        return [ModifierFunction.OVERRIDE_ANIMATION_RATE];
    }
...
export class modifier_creature_elite_3_tracking extends modifier_motion_hit_target {
    _OnCreated(params: any): void {
        ...
        const target_fx = ParticleManager.CreateParticle(
        ...
        ParticleManager.SetParticleControlEnt(effect_fx, 0, this.GetParent(), ParticleAttachment.POINT_FOLLOW, 'attach_fuse', Vector(0, 0, 0), false);
