...
export class modifier_creature_elite_5 extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        // 加个感叹号
        const cast_fx = GameRules.WarningMarker.CreateExclamation(this.GetParent());
    ...
    DeclareFunctions(): modifierfunction[] {
        return [ModifierFunction.INVISIBILITY_LEVEL, ModifierFunction.INCOMING_DAMAGE_PERCENTAGE, ModifierFunction.BASEDAMAGEOUTGOING_PERCENTAGE];
    }
