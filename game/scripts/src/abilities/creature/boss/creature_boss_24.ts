...
export class creature_boss_24 extends BaseCreatureAbility {
    ...
    OnAbilityPhaseStart(): boolean {
        ...
        this.nPreviewFX = GameRules.WarningMarker.Circular(400, this._cast_point, this.vOrigin);
        return true
    }
    ...
    OnIntervalThink(): void {
        if (this.GetStackCount() == 1) {
            ...
            if (enemies.length > 0) {
                ...
                let direction = this.vCaster - this.origin as Vector;
        ...
        if (this.GetStackCount() == 2) {
            let untis = Custom_FindUnitsInSector(
                DotaTeam.GOODGUYS,
                this.origin,
                this.end_vect,
                this.sector_angle,
